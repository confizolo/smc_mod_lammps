...
#ifdef FIX_CLASS
// clang-format off
FixStyle(bond/create/bridg,FixBondCreateBridg);
// clang-format on
#else

#ifndef LMP_FIX_BOND_CREATE_BRIDG_H
#define LMP_FIX_BOND_CREATE_BRIDG_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondCreateBridg : public Fix {
  friend class FixSRPREACT;

 public:
  FixBondCreateBridg(class LAMMPS *, int, char **);
  ~FixBondCreateBridg() override;
